...
![description](./images/bembembem_description.png)


I am also given a file:

![item](./items/bembembem.mp4)

I ran strings command in the .mp4 file and found something towards the end of it:


![hint1](./images/bembembem_hint1.png)


So i wrote a script to decode as specified in the hint:


![bembembem1](./scripts/bembembem_1.py)

And i got the text:

![hint2](./images/bembembem_hint2.png)
...
![hint2.2](./images/bembembem_hint2-2.png)
...
![hint3](./images/bembembem_hint3.png)
...
![hint4](./images/bembembem_hint4.png)
...
3) Roman figure 3 says after we Xor we can open the output file extracted from the tail of the video with the key we found in the spectrum. (K0t05t)


So i wrote a script that skips the video, grabs the hidden tail and uses the MD5 key to unscramble it back to a ZIP file.

![decode_script](./scripts/bembembem_2.py)


After i opened the resulting ***trunk.zip*** file with the password found in the spectrum:


![flag](./images/bembembem_flag.png)
